using DI___Life_Cycle.Services;
using Microsoft.AspNetCore.Mvc;

namespace DI___Life_Cycle.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class HomeController : ControllerBase
    {
        ...
        [HttpGet]
        public IActionResult LiefCycleReturn()
        {
            return Ok($"Transient1 : {_transientOperation1.OperationId} \n" +
